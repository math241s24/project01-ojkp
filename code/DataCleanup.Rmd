...
pm25_portland_2023 <- read_csv("../data/air_pollutants/pm25/pm25 portland 2023.csv", 
...
pm25_portland_2022 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2022.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
pm25_portland_2021 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2021.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
pm25_portland_2020 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2020.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
pm25_portland_2019 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2019.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
pm25_portland_2018 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2018.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
pm25_portland_2017 <- read_csv("../data/air_pollutants//pm25/pm25 portland 2017.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
...
so2_portland_2023 <- read_csv("../data/air_pollutants//so2/so2 portland 2023.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2022 <- read_csv("../data/air_pollutants//so2/so2 portland 2022.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2021 <- read_csv("../data/air_pollutants//so2/so2 portland 2021.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2020 <- read_csv("../data/air_pollutants//so2/so2 portland 2020.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2019 <- read_csv("../data/air_pollutants//so2/so2 portland 2019.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2018 <- read_csv("../data/air_pollutants//so2/so2 portland 2018.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
so2_portland_2017 <- read_csv("../data/air_pollutants//so2/so2 portland 2017.csv", 
                               col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
...
co_portland_2023 <- read_csv("../data/air_pollutants//co/co portland 2023.csv", 
                             col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
co_portland_2022 <- read_csv("../data/air_pollutants//co/co portland 2022.csv", 
                             col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
co_portland_2021 <- read_csv("../data/air_pollutants//co/co portland 2021.csv", 
                             col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
co_portland_2020 <- read_csv("../data/air_pollutants//co/co portland 2020.csv", 
                             col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
        ...
        COUNTY = col_skip(), SITE_LATITUDE = col_skip(), 
        SITE_LONGITUDE = col_skip()))
co_portland_2019 <- read_csv("../data/air_pollutants//co/co portland 2019.csv", 
                             col_types = cols(Date = col_date(format = "%m/%d/%Y"), Source = col_skip(), 
        `Site ID` = col_skip(), POC = col_skip(), 
        UNITS = col_skip(), `Site Name` = col_skip(), 
        DAILY_OBS_COUNT = col_skip(), PERCENT_COMPLETE = col_skip(), 
